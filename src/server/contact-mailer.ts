...
/* Old programmatic email signature — disabled in favor of the custom Gmail signature (royal-traders-gmail-signature.html), added manually via Gmail's signature settings.
            ...
            <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:100%;max-width:600px;background-color:#ffffff;">
              ...
              <tr>
                <td style="padding:32px;">
                  ...
                  <!-- Signature disabled — using the custom Gmail signature (royal-traders-gmail-signature.html) instead of buildSignatureHtml(). -->
                </td>
              </tr>
              <tr>
